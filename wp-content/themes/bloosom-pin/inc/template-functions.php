    ...
    <div class="footer-b">
		<div class="container">
            ...
            <?php
                ...
                echo '<a href="' . esc_url( 'https://blossomthemes.com/downloads/blossom-pin-free-wordpress-theme/' ) .'" rel="nofollow" target="_blank">'. esc_html__( 'Blossom Themes', 'blossom-pin' ) . '</a>.';
