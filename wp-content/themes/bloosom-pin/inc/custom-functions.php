        ...
        <div class="welcome-message notice notice-info">
            <div class="notice-wrapper">
                <div class="notice-text">
                    ...
                    <p><?php printf( __( '%1$s is now installed and ready to use. Click below to see theme documentation, plugins to install and other details to get started.', 'blossom-pin' ), $name ) ; ?></p>
...
if( ! function_exists( 'blossom_pin_admin_notice_display' ) ) :
/**
 * ignore notice
 */
function blossom_pin_admin_notice_display() {

    update_option( 'blossom-pin-update-notice', false );

}
endif;
add_action( 'after_switch_theme', 'blossom_pin_admin_notice_display' );